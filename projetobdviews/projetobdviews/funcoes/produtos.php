<?php
    ...
    function criarProdutos(string $nome, string $descricao, float $preco, int $estoque_minimo, int $categoria_id): bool {
        global $pdo;
    ...
    function alterarProduto(int $id, string $nome, string $descricao, float $preco, int $categoria_id, int $estoque_minimo) : bool{
        global $pdo;
