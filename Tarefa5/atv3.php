...
<html lang="en">
  ...
  <body>
    <form action="resp3.php" method="POST">
        <?php for ($i = 1; $i <= 5; $i++) { ?>
            <label for="codigo<?php echo $i; ?>">Código <?php echo $i; ?>:</label>
            <input type="text" name="codigo[]" id="codigo<?php echo $i; ?>"><br>
            <label for="nome<?php echo $i; ?>">Nome <?php echo $i; ?>:</label>
            <input type="text" name="nome[]" id="nome<?php echo $i; ?>"><br>
            <label for="preco<?php echo $i; ?>">Preço <?php echo $i; ?>:</label>
